...
#define EVX_LOAD_LIGHT_SAMPLE_MS		1000U
#define EVX_LOAD_MODERATE_SAMPLE_MS	300U
#define EVX_LOAD_HEAVY_SAMPLE_MS	200U
#define EVX_LOAD_WAKE_SAMPLE_MS		100U

#define EVX_LOAD_HEAVY_UP_SAMPLES	1U
#define EVX_LOAD_DOWN_SAMPLES		6U
